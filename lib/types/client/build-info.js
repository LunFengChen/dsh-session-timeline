...
export const PLUGIN_VERSION = typeof __DSH_REWIND_VERSION__ === 'string' ? __DSH_REWIND_VERSION__ : 'dev';
/** Short content hash of the client source, for stale-bundle detection. */
export const BUILD_HASH = typeof __DSH_REWIND_BUILD__ === 'string' ? __DSH_REWIND_BUILD__ : 'dev';
