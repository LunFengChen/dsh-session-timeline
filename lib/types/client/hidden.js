 ...
 */
export function resolveChatWatch(resolveView, sessionId, cb) {
 ...
 */
export function chatSnapshotOf(chatView) {
 ...
 */
export function messageTextAt(chat, seq) {
    if (chat === undefined)
        return undefined;
 ...
 */
export function targetSeqOfArgs(args) {
 ...
 */
export function isExecutedRewindCommand(node, seq) {
    if (node.name !== 'rewind' || node.outcome?.kind !== 'success')
        return false;
    ...
    if (node.outcome.sourceEventSeq === undefined)
        return false;
 ...
 */
export function hasFileImpact(text) {
    if (text === undefined)
        return true;
 ...
 */
export function isCandidateCommand(command) {
 ...
 */
export function hiddenSeqsOf(snap) {
