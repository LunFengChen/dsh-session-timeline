window.__ModuleLoader__.load({
	id: "@x1a0f3n9/dsh-session-timeline",
	factory: (require) => {
		var module = { exports: {} };
...
`;
		...
		*/
		function TimelineActions({ kind, seq, content, session, t }) {
			...
			const confirm = (0, react.useCallback)(() => {
				...
				close();
				if (selected === null || session === void 0 || busy.current) return;
				busy.current = true;
				(async () => {
					const prompt = selected === "regenerate" && content !== void 0 ? await historyPromptContent(session, content) : void 0;
					await session.cancel();
					const deleted = await session.deleteFrom(SessionSeq(seq));
					if (!deleted.ok) throw new Error(deleted.error.message);
					if (selected === "delete" || prompt === void 0) return;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				kind === "user" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.Tooltip, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.IconRefreshOutline16, {})
					})
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.Tooltip, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.IconTrashOutline16, {})
					})
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.RiskConfirmation, {
					open: action !== null,
		...
		*/
		function CompactButton({ session, t }) {
			const busy = (0, react.useRef)(false);
			...
			const onClick = (0, react.useCallback)(() => {
				if (session === void 0 || busy.current) return;
				busy.current = true;
				session.command("/compact").then((result) => {
					if (result.ok) return;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.Tooltip, {
			...
			}), toast !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_x1a0f3n9_dsh_client_ui_primitives.Toast, {
				text: toast.text,
				onDone: () => {
					setToast(null);
				}
		...
		function apply(ctx) {
			...
			ctx.effect(function* () {
				...
				const actionSession = () => {
					...
					return sessionId === void 0 ? void 0 : sessionOf(sessionId);
				};
				yield slots.inject("conversation.chat.user-actions", () => slots.register({
					...
					order: 1e3
				}, ({ seq, content }) => (0, react.createElement)(TimelineActions, {
					kind: "user",
					seq,
					content,
				...
				yield slots.inject("conversation.chat.assistant-actions", () => slots.register({
					...
					order: 1e3
				}, ({ seq }) => (0, react.createElement)(TimelineActions, {
					kind: "assistant",
					seq,
					session: actionSession(),
					t
				...
				yield slots.inject("conversation.input.right", () => slots.register({
					...
					order: 100
				}, () => (0, react.createElement)(CompactButton, {
					session: actionSession(),
					t
				})));
				...
				*/
				const fetchHostCandidates = async (face, chatOf) => {
					...
					const outcome = await waitForCommand(face, chatOf, (node) => isCandidateCommand(node) && !known.has(node.seq), 8e3, (cb) => watchChat(face.sessionId, cb));
